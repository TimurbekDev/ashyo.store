                ...
                <Swiper pagination={true} modules={[Pagination]} className="mySwiper">
                    ...
                    banners.map((item: BannerType) => (
                        <SwiperSlide className='pt-[37px] pb-[63px] sm:pt-[145px] relative sm:pb-[150px]' key={item.id}>
                            ...
                            <Image className='w-[200px] h-[200px] sm:w-[400px] sm:h-[400px] bottom-0 absolute sm:top-0 sm:bottom-0 sm:my-auto right-5' src={`${IMAGE_API}/${item.image}`} alt='Brand Img' width={400} height={600}/>
                        </SwiperSlide>
                    ))}
                </Swiper>
            </div>
